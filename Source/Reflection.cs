    ...
    namespace Reflection {
        public static class CharacterCardUtility {
            public static IEnumerable<WorkTags> WorkTagsFrom(WorkTags workTags) {
                return (IEnumerable<WorkTags>)ReflectionCache.Instance.CharacterCardUtility_WorkTagsFrom.Invoke(null,
                    new object[] { workTags });
            }
        }
        ...
        public static class ScenPart_StartingAnimal {
            public static IEnumerable<PawnKindDef> RandomPets(RimWorld.ScenPart_StartingAnimal scenPart) {
                return (IEnumerable<PawnKindDef>)ReflectionCache.Instance.ScenPart_StartingAnimal_RandomPets.Invoke(
                    scenPart, null);
            }
        }
        ...
        public static class GenFilePaths {
            public static string FolderUnderSaveData(string name) {
                return (string)ReflectionCache.Instance.GenFilePaths_FolderUnderSaveData.Invoke(null,
                    new object[] { name });
            }
        }
        ...
        public static class ScenPart_ForcedHediff {
            public static IEnumerable<HediffDef> PossibleHediffs(RimWorld.ScenPart_ForcedHediff scenPart) {
                return (IEnumerable<HediffDef>)ReflectionCache.Instance.ScenPart_ForcedHediff_PossibleHediffs.Invoke(
                    scenPart, null);
            }
        }
        ...
        public static class PawnBioAndNameGenerator {
            ...
            public static List<BackstoryCategoryFilter> GetBackstoryCategoryFiltersFor(Verse.Pawn pawn,
                FactionDef faction) {
                return (List<BackstoryCategoryFilter>)ReflectionCache.Instance
                    .PawnBioAndNameGenerator_GetBackstoryCategoryFiltersFor.Invoke(null,
                        new object[] { pawn, faction }
                    );
            }

            public static bool IsBioUseable(PawnBio bio, BackstoryCategoryFilter categoryFilter, PawnKindDef kind,
                Gender gender, string requiredLastName) {
            ...
            public static bool TryGetRandomUnusedSolidBioFor(List<BackstoryCategoryFilter> backstoryCategories,
                ...
                Object[] args = { backstoryCategories, kind, gender, requiredLastName, null };
                var value =
                    (bool)ReflectionCache.Instance.PawnBioAndNameGenerator_TryGetRandomUnusedSolidBioFor.Invoke(null,
                        args);
            ...
            public static BackstoryCategoryFilter GetFallbackCategoryGroup() {
                return (BackstoryCategoryFilter)ReflectionCache.Instance.PawnBioAndNameGenerator_FallbackCategoryGroup
                    .GetValue(null);
            }
        ...
        public static class PostLoadIniter {
            public static void ClearSaveablesToPostLoad(Verse.PostLoadIniter initer) {
                var saveables =
                    (HashSet<IExposable>)ReflectionCache.Instance.PostLoadIniter_SaveablesToPostLoad.GetValue(
                        Scribe.loader.initer);
                if (saveables != null) {
                    saveables.Clear();
                }
            }
