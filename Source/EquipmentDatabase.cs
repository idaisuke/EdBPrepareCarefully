...
namespace EdB.PrepareCarefully {
    public class EquipmentDatabase {
        ...
        public Pawn CreatePawn(ThingDef def, ThingDef stuffDef, Gender gender) {
            PawnKindDef kindDef = (from td in DefDatabase<PawnKindDef>.AllDefs where td.race == def select td)
                .FirstOrDefault();
            ...
            if (kindDef != null) {
                ...
                PawnGenerationRequest request = new PawnGenerationRequestWrapper() {
                    KindDef = kindDef, Faction = faction, MustBeCapableOfViolence = true
                }.Request;
